...
Mobile.tap(findTestObject('mobile/DayShop/Checkout/ButtonCheckoutProduk'), 0)

Mobile.getText(findTestObject('mobile/DayShop/Checkout/android.widget.TextView0 - If you have any inquiries or updates pls whatsap us at 94617563.'), 
    0)
...
Mobile.tap(findTestObject('mobile/DayShop/Checkout/ButtonCheckoutProdukAkhir'), 0)
...
Mobile.setText(findTestObject('mobile/address'), 'cisempur, jatinangor', 0)
